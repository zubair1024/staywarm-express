  ...
  window.App = {
    ...
    mainQuote() {
      ...
      if (invalid.length === 0) {
        ...
        let body = {
          ...
          HowManyRadiatorsAreInYourHome: this.model[
            "How many bedrooms do you have"
          ],
          HowManyBathtubsAreInYourHome: this.model[
        ...
        $.ajax({
          url:
            "https://api.247staywarm.co.uk/service1.asmx/CreateSalesFromService",
          data: body,
          type: "POST",
          headers: {
    ...
    optionSelected: function(
      ...
      switch (questionNumber) {
        case 0:
          gtag("event", "question_0_answered", {
